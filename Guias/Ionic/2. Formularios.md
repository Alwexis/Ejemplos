...
## <h2 id="cambiando_pagina_principal">🔃 Cambiando la página principal</h2>
...
## 📝 Añadiendo un modelo a nuestro Formulario
...
## 💻 Creando nuestra función submit y obteniendo datos
...
## 🎨 Añadiendo estilo a nuestro Formulario
...
Podemos modificar la página principal de nuestra aplicación ingresando al archivo `app-routing.module.ts` y cambiando el valor cuyo atributo `path` esté vacío. [Referencia](#cambiando_pagina_principal)
